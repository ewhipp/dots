...
function pom_draw_indicator(time_left, max_time)
    ...
    pom_draw_time_left_on_menu(pom.bar.c_left, main_screen, left_width, width,
                               pom.bar.color_time_remaining)
    pom_draw_time_left_on_menu(pom.bar.c_used, main_screen, 0, left_width,
                               pom.bar.color_time_used)
end
...
hs.hotkey.bind(cmd_ctrl, "1", function() pom_enable() end)
hs.hotkey.bind(cmd_ctrl, '0', function() pom_disable() end)
